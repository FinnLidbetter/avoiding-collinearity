...
/**
 * Tests for the com.numbers.WholeAndRt3 abstract number class operations.
 */
public class WholeAndRt3Tests {
    ...
    public void testValidAddition() {
        ...
        for (WholeAndRt3[] additionCase : cases) {
            ...
            Assertions.assertEquals(leftSummand.add(rightSummand), expectedSum);
        }
    }
    ...
    public void testValidSubtraction() {
        ...
        for (WholeAndRt3[] subtractionCase : cases) {
            ...
            Assertions.assertEquals(leftTerm.subtract(rightTerm),
                    expectedDifference);
        }
    }
    ...
    public void testMultiplication() {
        ...
        for (WholeAndRt3[] multiplicationCase: cases) {
            ...
            Assertions.assertEquals(leftMultiplicand.multiply(rightMultiplicand),
                    expectedProduct);
        }
    }
    ...
    public void testCompare() {
        ...
        Arrays.sort(arr);
        Assertions.assertArrayEquals(expectedOrder, arr);
    }
    ...
    public void testCommonDivisor() {
        ...
        for (WholeAndRt3[] commonDivisorCase: cases) {
            ...
            Assertions.assertEquals(leftTerm.commonDivisor(rightTerm),
                    expectedResult);
        }
    }
    ...
    public void testDivide() {
        ...
        for (WholeAndRt3[] divisionCase: cases) {
            ...
            Assertions.assertEquals(dividend.divide(divisor), expectedResult);
        }
    }
    ...
    public void testAdditiveInverse() {
        ...
        for (WholeAndRt3[] additiveInverseCase: cases) {
            ...
            Assertions.assertEquals(value.additiveInverse(), expectedResult);
        }
    ...
    public void testWholeInstantiation() {
        ...
        Assertions.assertEquals(base.whole(7), new WholeAndRt3(7,0));
    }
}
