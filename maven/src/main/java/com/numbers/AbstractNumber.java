 ...
 * implementing com.Trapezoid dimensions. If that abstract class were to extend
 * the com.numbers.AbstractNumber class, then the extending class could provide concrete
