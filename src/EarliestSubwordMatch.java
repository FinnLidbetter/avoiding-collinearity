public class EarliestSubwordMatch {
    ...
    private static void printHelp() {
        ...
        System.out.println("\tjava EarliestSubwordMatch start_index subword_length");
        System.out.println("Examples:");
        System.out.println("java EarliestSubwordMatch 2 3");
        System.out.println("java EarliestSubwordMatch 8 1");
    }
