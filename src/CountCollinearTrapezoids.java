...
public class CountCollinearTrapezoids {
            ...
            if (numberSystem.equals("wholeAndRt3")) {
                ...
                for (Interval searchInterval: searchIntervals) {
                    int intervalMaxCollinearCount = trapSeq.radialSweepCountCollinear(
                            searchInterval.lo, searchInterval.hi, maxIndexGap
                    );
    ...
    private static void printHelp() {
        ...
        System.out.println("\tjava CountCollinearTrapezoids maxIndexGap \"wholeAndRt3\"|\"wholeNumber\"");
        System.out.println("Examples:");
        System.out.println("java CountCollinearTrapezoids 7 wholeAndRt3");
        System.out.println("java CountCollinearTrapezoids 7 wholeNumber");
    }
